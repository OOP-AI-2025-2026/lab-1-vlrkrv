...
public class Main {
    ...
    public boolean icyHot(int temp1, int temp2) {
        ...
        return (temp1 > maxRange && temp2 < minRange) || (temp1 < minRange && temp2 > maxRange);
    }
    ...
    public boolean in1020(int a, int b) {
        ...
        return (a >= minRange && a <= maxRange) || (b >= minRange && b <= maxRange);
    }
    ...
    public boolean hasTeen(int a, int b, int c) {
        final int minRange = 13;
        final int maxRange = 19;
        return (a >= minRange && a <= maxRange) || (b >= minRange && b <= maxRange) || (c >= minRange && c <= maxRange);
    }
